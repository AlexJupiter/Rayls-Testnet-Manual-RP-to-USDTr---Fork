  ...
  return <BrowserRouter>
      <Layout>
        <Routes>
          ...
          <Route path="/token/:tokenType" element={<TokenDetail />} />
          <Route path="/vault/:vaultType" element={<VaultLock />} />
          <Route path="/validate-microdeposits" element={<ValidateMicrodeposits walletAddress={walletAddress} />} />
          <Route path="/create-attestation" element={<CreateAttestation walletAddress={walletAddress} />} />
        </Routes>
      </Layout>
    </BrowserRouter>;
}